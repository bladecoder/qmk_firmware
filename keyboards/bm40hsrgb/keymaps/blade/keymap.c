...
[_QWERTY] = LAYOUT_planck_mit(
    TABNUM,         KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    BKSPNUM,
    ...
    TD(TD_COPY_CUT), TD(TD_PASTE_UNDO),KC_LALT,KC_LGUI,   LOWER,    KC_SPC       ,   RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT 
),
...
[_LOWER] = LAYOUT_planck_mit(
    ...
    KC_DEL,  XXXXXXX, XXXXXXX, ES_EURO , XXXXXXX, XXXXXXX, ES_IQUE,  ES_QUES,     ES_EQL,    ES_LCBR, ES_RCBR, ES_DQUO,
    _______, ES_LABK, ES_RABK, ES_GRV,  XXXXXXX, XXXXXXX, ES_IEXL,  ES_EXLM,    ES_SLSH,    ES_ASTR, ES_PLUS, _______,
...
[_RAISE] = LAYOUT_planck_mit(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_INS,  KC_PSCR,  ES_LBRC, ES_RBRC, ES_QUOT,
